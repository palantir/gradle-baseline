 ...
 */
public abstract class AbstractBaselinePlugin extends GroovyObjectSupport implements Plugin<Project> {
    ...
    protected final String getConfigDir() {
        return Paths.get(project.getRootDir().toString(), BaselineParameters.DEFAULT_CONFIG_DIR)
                .toString();
    }
}
