...
- `GradleTaskConfigurationAvoidance`: Forbid gradle apis that eagerly create tasks. Learn more [here](https://docs.gradle.org/current/userguide/task_configuration_avoidance.html)
