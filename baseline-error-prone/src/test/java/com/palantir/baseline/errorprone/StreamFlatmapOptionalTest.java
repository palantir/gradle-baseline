...
class StreamFlatmapOptionalTest {
    ...
    public void test() {
        fix().addInputLines(
                        ...
                        "  }",
                        "  Stream<String> flatMap_streams_simple(Stream<Optional<String>> in) {",
                        "    return in.flatMap(Streams::stream);",
                        "  }",
                        ...
                        "  }",
                        "  Stream<String> flatMap_streams_flatMap_collection("
                                + "Stream<Optional<Collection<String>>> in) {",
                        "    return in.flatMap(Streams::stream).flatMap(Streams::stream);",
                        "  }",
                ...
                .addOutputLines(
                        ...
                        "  Stream<String> flatMap_streams_flatMap_collection("
                                + "Stream<Optional<Collection<String>>> in) {",
                        "    return in.<Collection<String>>mapMulti(Optional::ifPresent).flatMap(Streams::stream);",
                        "  }",
                        "  Stream<String> flatMap_optional_flatMap_optional(Stream<Optional<Optional<String>>> in) {",
