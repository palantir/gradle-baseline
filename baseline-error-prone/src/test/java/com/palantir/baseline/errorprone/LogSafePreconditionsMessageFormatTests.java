...
public final class LogSafePreconditionsMessageFormatTests extends PreconditionsTests {
    ...
    public void testCheckArgument_printf() {
        failLogSafe(
                PRINTF_DIAGNOSTIC,
                "Preconditions.checkArgument(param != \"string\", \"message %s\"," + " UnsafeArg.of(\"long\", 123L));");
    }
    ...
    public void testCheckState_printf() {
        failLogSafe(
                PRINTF_DIAGNOSTIC,
                "Preconditions.checkState(param != \"string\", \"message %s\"," + " UnsafeArg.of(\"long\", 123L));");
    }
    ...
    public void testCheckNotNull_printf() {
        failLogSafe(
                PRINTF_DIAGNOSTIC,
                "Preconditions.checkNotNull(param, \"message %s\"," + " UnsafeArg.of(\"long\", 123L));");
    }
    ...
    public void testCheckArgument_slf4j() {
        failLogSafe(
                SLF4J_DIAGNOSTIC,
                "Preconditions.checkArgument(param != \"string\", \"message {}\"," + " UnsafeArg.of(\"long\", 123L));");
    }
    ...
    public void testCheckState_slf4j() {
        failLogSafe(
                SLF4J_DIAGNOSTIC,
                "Preconditions.checkState(param != \"string\", \"message {}\"," + " UnsafeArg.of(\"long\", 123L));");
    }
    ...
    public void testCheckNotNull_slf4j() {
        failLogSafe(
                SLF4J_DIAGNOSTIC,
                "Preconditions.checkNotNull(param, \"message {}\"," + " UnsafeArg.of(\"long\", 123L));");
    }
