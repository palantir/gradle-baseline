...
class IllegalSafeLoggingArgumentTest {
    ...
    public void testTransformingStreamCollectors() {
        helper().addSourceLines(
                        ...
                        "    fun(stream.collect(ImmutableListMultimap.toImmutableListMultimap(TopLevel::name, TopLevel::value)));",
                        "    fun(stream.collect(ImmutableListMultimap.flatteningToImmutableListMultimap(TopLevel::name, v -> Stream.of(v.value()))));",
                        "    fun(stream.collect(ImmutableSetMultimap.toImmutableSetMultimap(TopLevel::name, TopLevel::value)));",
                        "    fun(stream.collect(ImmutableSetMultimap.flatteningToImmutableSetMultimap(TopLevel::name, v -> Stream.of(v.value()))));",
